...
alias scg='ssh dnachun@login04.scg.stanford.edu'
alias scg_mount='sshfs dnachun@scg.stanford.edu:/home/dnachun/ ~/scg -o follow_symlinks'
...
#POWERLEVEL9K_CONTEXT_SUDO_FOREGROUND="000"
...
#SSH
#eval $(keychain --eval --quiet ~/.ssh/id_hoffman2 ~/.ssh/id_orion ~/.ssh/id_rsa_icnn ~/.ssh/coppolab ~/.ssh/mistachie777 ~/.ssh/id_scg ~/.ssh/id_sherlock)
eval $(keychain --eval --quiet ~/.ssh/mistachie777 ~/.ssh/id_scg ~/.ssh/id_sherlock)
